...
<body >
    ...
    <form method="POST">
      ...
      <table align="top" width="50%" border="3" border color="goldenrod">
			<tr>
        <td align="center"><h3><font color="red">Patient Login Here :</font></h3></td></tr>
			<p>
			...
			<p>
				Not a member yet?</p>
				<p><a href="newpatient.php"><input type="button" name="submit" value=" Register Here" size="8" style="font-size:12pt;color:white;background-color:midnightblue;border:2px solid #191970;padding:3px" /></a></p>
    ...
    <marquee ><font color="red" size="8">Please Co-operate with us for better services.</font></marquee>
		...
		<?php
			...
			if(isset($_POST['submit'])) 
			{
        		...
        		{
            		$query=mysql_query("select * from patient where username='$username' and password='$password'");
            		...
            		if(mysql_num_rows($query)>0)
           			{
                		...
                		while($res=mysql_fetch_array($query))
                		{
                			...
                			if($count==1)
                			{
                 				...
                 				echo "<script>window.open('welcomepatient.php','_self');</script>";
                 			}
                 		}
            		else
            		{
